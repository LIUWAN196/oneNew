...
if __name__ == '__main__':
    ...
    model_path = '/home/wanzai/桌面/model_and_cfg_and_ofmap_folder/model_and_cfg_zoo/model/todo/yolov7.onnx'
    model = onnx.load(model_path)
    providers = ['CPUExecutionProvider']

    # step 2: load input data
    img = np.fromfile("/home/wanzai/桌面/model_and_cfg_and_ofmap_folder/ofmap4debug/yolov7/model_ifmap.bin", dtype=np.float32)
    ...
    onenew_bash_folder = '/home/wanzai/桌面/model_and_cfg_and_ofmap_folder/ofmap4debug/yolov7/'
