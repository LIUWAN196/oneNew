...
if __name__ == '__main__':
    ...
    model_path = '/home/wanzai/桌面/model_and_cfg_and_ofmap_folder/model_and_cfg_zoo/model/onnx_model/inception_v3.onnx'
    model = onnx.load(model_path)
    providers = ['CPUExecutionProvider']

    # step 2: load input data
    img = np.fromfile("/home/wanzai/桌面/model_and_cfg_and_ofmap_folder/ofmap4debug/inception_v3/model_ifmap.bin", dtype=np.float32)
    ...
    # 先不检验最终的输出结果
    out_tensor_list = ['']
    onenew_bash_folder = '/home/wanzai/桌面/model_and_cfg_and_ofmap_folder/ofmap4debug/inception_v3/'
