...
if __name__ == '__main__':
    ...
    model_path = '/home/wanzai/桌面/oneNew/tools/liu_resnet18.onnx'
    model = onnx.load(model_path)
    providers = ['CPUExecutionProvider']

    # step 2: load input data
    img = np.fromfile("/home/wanzai/桌面/oneNew/cmake-build-debug/host/op/res18_input.bin", dtype=np.float32)
