...
if __name__ == '__main__':
    ...
    model_path = '/home/wanzai/桌面/oneNew/model_and_cfg_zoo/model/onnx_model/resnet50.onnx'
    model = onnx.load(model_path)
    providers = ['CPUExecutionProvider']

    # step 2: load input data
    img = np.fromfile("/home/wanzai/桌面/oneNew/ofmap4debug/resnet50/model_ifmap.bin", dtype=np.float32)
    ...
    # 先不检验最终的输出结果
    out_tensor_list = ['495']
    onenew_bash_folder = '/home/wanzai/桌面/oneNew/ofmap4debug/resnet50/'
