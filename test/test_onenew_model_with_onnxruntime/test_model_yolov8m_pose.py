...
if __name__ == '__main__':
    ...
    model_path = '/home/wanzai/桌面/oneNew/tools/yolov8m_pose_export_6_tensor.onnx'
    # model_path = '/home/wanzai/桌面/oneNew/tools/liu_yolov8_seg.onnx'
    model = onnx.load(model_path)
    providers = ['CPUExecutionProvider']

    # step 2: load input data
    img = np.fromfile("/home/wanzai/桌面/oneNew/cmake-build-debug/host/op/yolov8_seg_input.bin", dtype=np.float32)
    ...
    # 先不检验最终的输出结果
    out_tensor_list = []  # yolo v8 seg
    # out_tensor_list = ['/model.24/m.0/Conv_output_0', '/model.24/m.1/Conv_output_0', '/model.24/m.2/Conv_output_0']  # yolo v8 seg
    # out_tensor_list = ['output', '456', '458']  # yolo v5m
    onenew_bash_folder = '/home/wanzai/桌面/oneNew/cmake-build-debug/host/op/'
    ...
    for (key, value) in ort_out_desc.items():
        ...
        if ((cos_sim < 0.98) | (math.isnan(cos_sim))):
