...
function model_daily_test_main() {
    ...
    for model_cfg in $model_yml_list; do
        ...
        cd ${sh_script_dir}
        python ./compare_ofmap.py ${onnx_dir}/${model_name}".onnx" ${sh_script_dir}/tmp_ofmap_path/${model_name}/
    ...
    for model_cfg in $model_yml_list; do
        ...
        cd ${sh_script_dir}
        python ./compare_ofmap.py ${onnx_dir}/${model_name}".onnx" ${sh_script_dir}/tmp_ofmap_path/${model_name}/ "opt_model"
