...
typedef struct
{
    int32_t resize_size[2] = {256, 256};
    int32_t crop_size[2] = {2, 2};
    COLOR_CODE_E out_color_code = RGB;
    RESIZE_METHOD_E resize_method = INTER_LINEAR;
...
//    // step 1 : resize img
//    cv::Mat resized_img;
//    cv::resize(ori_img, resized_img, cv::Size(resize_h, resize_w), 0, 0, trans_cfg.resize_method);
//
...
//
//    if (trans_cfg.out_color_code == RGB)
//    {
//        cv::cvtColor(cropped_img, cropped_img, cv::COLOR_BGR2RGB);
//    }
//    else if (trans_cfg.out_color_code == BGR)
//    {
//        // need do nothing
//    }
//    else
//    {
//        std::cout << "the set of out color is: " << trans_cfg.out_color_code << ", dont support now!" << std::endl;
//        return -1;
//    }
//
...
//
//    rgb_vec.insert(rgb_vec.end(), r.begin(), r.end());
//    rgb_vec.insert(rgb_vec.end(), g.begin(), g.end());
//    rgb_vec.insert(rgb_vec.end(), b.begin(), b.end());
//
...
int main()
{
    ...
    // trans_cfg.crop_size[0] = 2;
    // trans_cfg.crop_size[1] = 2;
