...
#ifndef ONENEW_PAD_CONV_H
#define ONENEW_PAD_CONV_H
...
int do_pad_conv(char *dst_ptr, char *src_ptr, OPERAND_S *src_data_desc, PAD_INNER_CONFIG_S *cfg) {
    ...
    int32_t src_c = src_data_desc->shape.C;
    int32_t src_h = src_data_desc->shape.H;
    int32_t src_w = src_data_desc->shape.W;

    int32_t dst_c = src_data_desc->shape.C;
